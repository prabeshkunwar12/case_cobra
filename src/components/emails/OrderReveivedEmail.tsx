...
const OrderReveivedEmail = ({
    ...
    const baseUrl = process.env.NODE_ENV === "development" ? 'http//:localhost"3000' : 'https://case-cobra-henna.vercel.app'
...
export default OrderReveivedEmail
